...
%On a scale of 0 to 10, \textbf{\underline{B}}eginner:1-3, Prior Experience:4-5,
%Proficient:6-7, Expert:8-10
...
Wireshark, gnuplot, dotty, ctags, cscope, Java Servlets, \LaTeX{}.}
    ...
    %\item{\textbf{Expert}: C.}
    %\vspace{-.1cm}
    %\item{\textbf{Proficient}: Java, Algorithms, Data Structures, , Linux,
    %Windows.}
    %\vspace{-.1cm}
    %\item{\textbf{Prior Experience}: C++, Python, VB, GDB, MySQL, HTML \& CSS,
    %SVN/Git, Wireshark, gnuplot, dotty, ctags, cscope, Java Servlets, \LaTeX.}
    %\vspace{-.1cm}
\end{itemize}
